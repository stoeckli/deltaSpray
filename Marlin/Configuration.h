...
#define HOMING_FEEDRATE {1600, 1600, 1600, 3, 3}  // set the homing speeds (mm/s)
...
#define DEFAULT_MAX_ACCELERATION      {3000, 3000, 3000, 3000, 0.1}    // X, Y, P, V maximum start speed for accelerated moves.
...
#define DEFAULT_VJERK                 0.1   // (mm/sec)
